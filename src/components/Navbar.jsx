  ...
  return (
   <nav className='w-full text-white flex items-center justify-between bg-gray-700 sticky t-0 '>
    ...
    <ul className='flex justify-center items-start  list-none md:hidden lg:flex'>
      ...
      <li className='mx-2 my-4 pointer text-lg font-medium hover:text-red-600 '><a href='#home' >About us</a></li>
      <li className='mx-2 my-4 pointer text-lg font-medium hover:text-red-600 '><a href='#home' >Programs</a></li>
      <li className='mx-2 my-4 pointer text-lg font-medium hover:text-red-600 '><a href='#home' >Membership</a></li>
      <li className='mx-2 my-4 pointer text-lg font-medium hover:text-red-600 '><a href='#home'>Testimonals</a></li>
      <li className='mx-2 my-4 pointer text-lg font-medium hover:text-red-600 '><a href='#home'>Contacts</a></li>
    </ul>
      ...
      <div className="hidden pointer  text-left text-white md:flex">
        ...
        <div className="fixed top-0 left-0 w-full h-[90%] bg-gray-700 text-white flex flex-col z-10 font-semibold text-lg ease-in ">
          ...
          <ul className="list-none ">
              ...
              <li className='m-8 pointer text-xl text-center'><a href="#profile" onClick={() => setToggleMenu(false)}>Contact</a></li>
            </ul>
